const FORM_DEFS = {
        ...
        sections: [
          {
            inputs: [
              ...
              },
              {
                ...
                data_attributes: {
                  prev_action: 'replace',
                  options_list: 'MultiList',
                },
              },
              {
                id: 'main_stem_tag_r',
                column_name: 'main_stem_tag',
                label: 'Main stem tag',
                html_element: 'input',
              ...
              {
              column_name: "hom",
              label: "Height of Measurement (cm)",
              html_element: "input",
              html_attributes: { type: 'number' },
              data_attributes: { prev_action: 'replace' },
              },
        ...
        sections: [
          {
            inputs: [
              ...
              },
              {
                              // Comma Check
                              modal: true,
                              modal_id: 'comma_check_r',
                              label_id: 'comma_check_Label_r',
                              title: 'Comma Check',
                              text: 'Commas not allowed, use semicolon to separate comments',
                              buttons: [
                                       {
                                         id: 'ok_comma_check_r',
                                         text: 'Ok',
        ...
        sections: [
          {
            inputs: [
              ...
              },
              {
                ...
                title: 'DBH Check',
                text: 'Dbh is < 1 cm - is that correct?',
                buttons: [
                  {
                    id: 'yes_dbh_op1_i',
                    text: 'Yes',
        ...
        sections: [
          {
            inputs: [
               ...
               },
              {
                // Comma Check
                modal: true,
                modal_id: 'comma_check_i',
                label_id: 'comma_check_Label_i',
                title: 'Comma Check',
                text: 'Commas not allowed, use semicolon to separate comments',
                buttons: [
                         {
  ...
  stand_doc: {
    table: "stand_doc",
    header: "Quadrat Documentation Form",
    cards: [
      {
        id: "stand_info",
        header: "Quadrat Info",
